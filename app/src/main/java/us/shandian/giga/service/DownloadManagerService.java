...
//        };
    ...
    private void manageObservers(Handler.Callback handler, boolean add) {
        synchronized (mEchoObservers) {
            if (add) {
    ...
    public class DownloadManagerBinder extends Binder {
        ...
        public void addMissionEventListener(Handler.Callback handler) {
            manageObservers(handler, true);
        }

        public void removeMissionEventListener(Handler.Callback handler) {
